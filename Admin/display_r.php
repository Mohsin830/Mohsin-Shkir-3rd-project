  ...
  <div class="container-fluied">
    <div class="row">
      ...
      <div class="col-lg-9 col-md-6 col-sm-12 mt-2">
        <div class="ms-3 mt-5">
          <button><a href="index_r.php">Add New Data</a></button>
        </div>
                ...
                <div class=" bg-success text-light">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td scope="col">
                        <a href="update_r.php?id=<?php echo $result['id']; ?>"><i class="far fa-edit ms-3"></i></a>
                        <!-- <a href="detail.php?id=<?php echo $result['id']; ?>" <i class="far fa-user ms-3"></i></a> -->
                        <a href="delete_r.php?id=<?php echo $result['id']; ?>"><i class="far fa-trash ms-3"></i></a>
                      </td>
                    </tr>
